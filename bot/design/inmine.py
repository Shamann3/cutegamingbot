    ...
    if x in game['mines']:
        ...
        if bet > 0:
            try:
                ...
                print(f"[MINES_INLINE][GFUND] apply_commission_pvp err={e!r}")
        ...
        await db.cutehistory_plus(winner_id , net_bet , "инлайн мины")
        ...
        if total_pot > 0:
            ...
            keyboard_rows = [ [ button ] , [ button3 ], [ button2 ],[ btn_create_inmine ] ]
            if gfund_result:
