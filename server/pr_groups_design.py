...
TASKS_MENU = {
    "text": "Комиссия в группах",
    "icon": "<tg-emoji emoji-id='5391270106464539040'>😐</tg-emoji>",
}

HELP_TASKS = t("""
<tg-emoji emoji-id='5424616516018537963'>🎁</tg-emoji> <b>Комиссия в группах</b>

<blockquote><b><i>Эту систему сделали, чтобы вы могли зарабатывать. И чтобы о проекте узнавали новые люди.

Новый человек играет в группе. С его игры берётся комиссия. С неё и идёт заработок.

Владелец группы: не 35% на карман. Вам игроки и баланс группы.
Кто пригласил бота в чужую группу: до 35% комиссии, 14 дней, на личный баланс.
Новым пользователям проект выдаёт подарочные куты. Откройте задание.</i></b></blockquote>
...
SCREENS: dict[str, dict] = {
    ...
    'hub': msg(
        ...
        <b>Новый человек играет в группе. С его игры берётся комиссия. С неё и идёт заработок.</b>

        <blockquote><b><i>Если вы владелец группы
Новым пользователям проект выдаёт подарочные куты. Играть ими можно только у вас.
Вам не <u>35%</u> комиссии на карман. Вам игроки и баланс группы. Срок: <u>14 дней</u>.</i></b></blockquote>

        <blockquote><b><i>Если вы пригласили бота в чужую группу
Новым пользователям проект выдаёт подарочные куты. Играть они будут уже там.
Вам на личный баланс идёт до <u>35%</u> комиссии. Срок: <u>14 дней</u>.
Нужно подтверждение, что вы порекомендовали добавить бота.</i></b></blockquote>
    ...
    'choose': msg(
        ...
        <b>Комиссия одна. Заработок у владельца и у того, кто привёл бота, разный.</b>

        <blockquote><b><i>Владелец: игроки и баланс группы. Не 35% комиссии на карман.
Чужая группа: до 35% комиссии вам, 14 дней, на личный баланс.
Новым пользователям проект выдаёт подарочные куты.</i></b></blockquote>
    ...
    'how_owner': msg(
        ...
        <b>Игры идут у вас в чате. Комиссия остаётся в балансе группы, не вам на карман.</b>

        <blockquote><b><i>Новым пользователям проект выдаёт подарочные куты.
Играть ими можно только у вас. Снять или перевести нельзя.
Вам игроки и баланс группы. Не 35% на карман. Срок: 14 дней. Только новые люди.</i></b></blockquote>
    ...
    'how_reco': msg(
        ...
        <b>Вы привели бота в чужую группу. Вам идёт доля комиссии, 14 дней.</b>
...
Нужно подтверждение, что вы порекомендовали добавить <u>@CuteGamingBot</u>.</i></b></blockquote>
    ...
    'bot_joined': msg(
        ...
        <b>Нажмите, кто вы. Дальше бот откроет только ваш путь и ваш заработок.</b>

        <blockquote><b><i>Новым пользователям проект выдаёт подарочные куты.
Если группа своя, вам игроки и баланс группы, не 35% комиссии на карман.
Если чужая, и вы привели бота, вам начисляется доля комиссии.</i></b></blockquote>
        """,
        buttons=[ b(
    ...
    'pick_role': msg(
        ...
        <b>Кто вы в этой группе? От этого зависит, куда пойдёт комиссия.</b>

        <blockquote><b><i>Новым пользователям проект выдаёт подарочные куты.

Если группа своя, новички играют только у вас. Вам игроки и баланс группы, не доля на карман.

Если чужая, и вы привели бота, вам на личный баланс идёт доля с их игр. Нужно подтверждение рекомендации.</i></b></blockquote>
    ...
    'owner_bridge': msg(
        ...
        <blockquote><b><i>Новым пользователям проект выдаёт подарочные куты. Играть этим подарком можно только у вас. Если знакомый просил добавить Кут, пусть сам пришлёт ссылку в бота.</i></b></blockquote>
...
Играть этим подарком можно только у вас, в этой группе.
Вам остаются игроки и баланс группы, не 35% на карман.</i></b></blockquote>
...
Ничего нажимать не нужно: куты капают сами.</i></b></blockquote>
    ...
    'accepted_owner': msg(
        ...
        <b>Следующие <u>{days} дней</u> новые люди играют у вас на подарок проекта.</b>

        <blockquote><b><i>Новым пользователям проект выдаёт подарочные куты.
Играть этим подарком можно только у вас, в одиночных играх.
Снять или перевести нельзя. Это подарок новичкам, не ваши личные деньги.
Ничего нажимать не нужно: куты капают сами.</i></b></blockquote>
    ...
    'gift': msg(
        ...
        <blockquote><b><i>Новым пользователям проект выдаёт подарочные куты. Играть ими можно только в этой группе, в одиночных играх. Снять или перевести этот подарок нельзя.</i></b></blockquote>
    ...
    'gift_locked': msg(
        ...
        <blockquote><b><i>Новым пользователям проект выдаёт подарочные куты. Снять или перевести нельзя: этим подарком учатся играть только в этой группе.</i></b></blockquote>
        """,
    ),
