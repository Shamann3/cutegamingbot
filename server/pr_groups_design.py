...
<blockquote><b><i>Новым пользователям проект выдаёт подарочные куты. Если сдаёте свою группу - играют только у вас. Если рекомендуете бота в чужой - до 35% комиссии вам, 14 дней, нужно подтверждение рекомендации. Ответ придёт сюда.</i></b></blockquote>
...
SCREENS: dict[str, dict] = {
    ...
    'hub': msg(
        ...
        <b>Добавьте Кут в чат. Новым пользователям проект выдаёт подарочные куты.</b>

        <blockquote><b><i>Если вы хотите сдать на задание свою группу
...
Если вы хотите рекомендовать бота в чужой группе
Новым пользователям проект выдаёт подарочные куты. Играть - в той группе.
Вам капает до 35% комиссии с их игр.
14 дней. Нужно подтверждение, что вы порекомендовали добавить бота.</i></b></blockquote>
    ...
    'choose': msg(
        ...
        <blockquote><b><i>Если вы хотите сдать на задание свою группу
Новым пользователям проект выдаёт подарочные куты. Играть только у вас.

Если вы хотите рекомендовать бота в чужой группе
Новым пользователям проект выдаёт подарочные куты. Вам до 35% комиссии с их игр.
14 дней. Нужно подтверждение, что вы порекомендовали добавить бота.</i></b></blockquote>
...
Снять или перевести нельзя. Это не ваши деньги - это подарок новичкам.
Вам не 35% на карман - вам игроки и баланс группы.
14 дней. Только те, кого Кут ещё не знал.</i></b></blockquote>
    ...
    'how_reco': msg(
        ...
        <b>Нужно подтверждение, что вы порекомендовали добавить <u>@CuteGamingBot</u>. Сначала его добавляют в админы.</b>

        <blockquote><b><i>Если вы хотите рекомендовать бота в чужой группе
Новым пользователям проект выдаёт подарочные куты. Играть ими можно только в той группе.
Человек первый раз играет в Кут через этот чат.
...
Куты приходят вам на баланс сами.</i></b></blockquote>
    ...
    'bot_joined': msg(
        ...
        <blockquote><b><i>Новым пользователям проект выдаёт подарочные куты. Если сдаёте свою группу - играют у вас. Если рекомендуете бота в чужой - доля вам, нужно подтверждение рекомендации.</i></b></blockquote>
        """,
        buttons=[ b(
...
Если вы хотите сдать на задание свою группу - играют только у вас.

Если вы хотите рекомендовать бота в чужой группе - доля вам с их игр, нужно подтверждение рекомендации.</i></b></blockquote>
...
Куты приходят вам на баланс сами.</i></b></blockquote>
    ...
    'after_photos_reco': msg(
        ...
        <b>Создатель должен подтвердить, что вы порекомендовали добавить бота. На это <u>24 часа</u>.</b>

        <blockquote><b><i>Он нажмёт <u>Да</u>. Без подтверждения проверку не начнём. Новым пользователям проект выдаёт подарочные куты.</i></b></blockquote>
    ...
    'wrote_confirm': msg(
        ...
        text="""
        <b>Ждём подтверждение рекомендации</b>
