...
<blockquote><b><i>Если вы хотите сдать на задание свою группу - подарки игрокам у вас. Если рекомендуете бота в чужой группе - до 35% комиссии вам, 14 дней, нужно подтверждение, что вы порекомендовали добавить бота. Ответ придёт сюда.</i></b></blockquote>
...
Если вы хотите рекомендовать бота в чужой группе
Вам до 35% комиссии. 14 дней. Нужно подтверждение, что вы порекомендовали добавить бота.</i></b></blockquote>
...
Куты приходят вам на баланс сами.</i></b></blockquote>
    ...
    'bot_joined': msg(
        ...
        <blockquote><b><i>Если вы сдаёте свою группу - подарки у вас. Если рекомендуете бота в чужой - доля вам, нужно подтверждение, что вы порекомендовали добавить бота.</i></b></blockquote>
        """,
        buttons=[ b(
    ...
    'pick_role': msg(
        ...
        <blockquote><b><i>Если вы хотите сдать на задание свою группу - подарки игрокам у вас.

Если вы хотите рекомендовать бота в чужой группе - доля вам, нужно подтверждение, что вы порекомендовали добавить бота.</i></b></blockquote>
    ...
    'reco_bridge': msg(
        ...
        <blockquote><b><i>Сначала 3 фото. Потом в группе напишите «подтверждение» - что вы порекомендовали добавить бота.</i></b></blockquote>
...
Куты приходят вам на баланс сами.</i></b></blockquote>
    ...
    'after_photos_reco': msg(
        ...
        <blockquote><b><i>Он нажмёт <u>Да</u>. Без подтверждения проверку не начнём.</i></b></blockquote>
    ...
    'wrote_confirm': msg(
        ...
        <blockquote><b><i>Создатель должен подтвердить, что вы порекомендовали добавить бота. Без этого доля вам не пойдёт.</i></b></blockquote>
...
Сегодня: <u>{today}</u></i></b></blockquote>
    ...
    'confirm': msg(
        ...
        <blockquote><b><i>Так вы подтвердите его рекомендацию. Тогда задание будет выполнено.</i></b></blockquote>
        """,
        buttons=[
            [
                b(
    ...
    'accepted': msg(
        ...
        <blockquote><b><i>До 35% с их игр - на ваш баланс.
Только те, кого Кут ещё не знал.
Ничего нажимать не нужно - куты капают сами.</i></b></blockquote>
    ...
    'accepted_owner': msg(
        ...
        <blockquote><b><i>Новым даём куты в подарок.
