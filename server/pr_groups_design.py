...
SCREENS: dict[str, dict] = {
    ...
    'hub': msg(
        ...
        <b>Главное: рекомендуйте Кут в новые группы. Вам до <u>35%</u> комиссии, <u>14 дней</u>, на личный баланс.</b>

        <blockquote><b><i>Чужая группа
Новым пользователям проект выдаёт подарочные куты.
Вы привели бота. С их игр вам идёт доля. Нужно подтверждение.</i></b></blockquote>

        <blockquote><b><i>Если вы владелец своей группы
Это помощь чату, не 35% на карман.
Новым пользователям проект выдаёт подарочные куты.
