...
# Чёрный рынок — технический чат (дом в играх, growth fund)
TECH_CHAT_ID = -1003855337972

# Фоновые заработки — сюда идут комиссия биржи и отчисления с покупок
# в магазине. Отдельное имя, а не переиспользование TECH_CHAT_ID:
# накопленное на чёрном рынке остаётся там, где лежало.
